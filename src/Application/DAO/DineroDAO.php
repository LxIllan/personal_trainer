...
class DineroDAO
{
    ...
    public function realizarGasto(int $idSucursal, Exercise $gasto) : bool
    {
    ...
    public function dameGasto(int $idGasto) : ?Exercise
    {
        ...
        return (isset($tupla)) ? new Exercise($tupla[0], $tupla[1], $tupla[2], $tupla[3], $tupla[4]) : null;
    }
